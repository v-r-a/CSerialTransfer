...
const uint8_t CONTINUE = 3;
const uint8_t NEW_DATA = 2;
const uint8_t NODATA = 1;
const uint8_t CRC_ERROR = 0;
const uint8_t PAYLOAD_ERROR = -1;
const uint8_t STOP_BYTE_ERROR = -2;
const uint8_t STALE_PACKET_ERROR = -3;
const uint8_t START_BYTE = 0x7E;
const uint8_t STOP_BYTE = 0x81;
const uint8_t PREAMBLE_SIZE = 4;
const uint8_t POSTAMBLE_SIZE = 2;
const uint8_t MAX_PACKET_SIZE = 254;
...
*/
    ...
    public: // <<---------------------------------------//public
        ...
        SerialTransfer(const char *device, int baudRate, functionPtr *_callbacks = NULL, uint8_t _callbacksLen = 0) : packet(_callbacks, _callbacksLen)
        {
            ...
            tty.c_cflag &= ~CRTSCTS;       // Disable RTS/CTS hardware flow control // Venky edits: don't understand this.
            ...
            case 115200:
                ...
                break;
            case 500000: // Venky edits
                cfsetospeed(&tty, B500000);
                break;
            case 1000000: // Venky edits
        ...
        */
        uint8_t available()
        {
            ...
            if (fion) // Venky edits: fion is the number of bytes available to read.
            {
